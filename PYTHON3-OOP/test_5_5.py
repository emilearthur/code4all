...
# the manager object will be responsible for ensuring the ff in the order: 
# 1. Unzipping the compressed file 2. Performng the find-and-replace action 3. Zipping up the new file
