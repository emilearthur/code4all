...
useradd -M apiuser
usermod -L apiuser
setfacl -m u:apiuser:rwx /apps/logs/weather_api # run after running file structure
...
# clone the repo: 
cd /apps 
git clone https://github.com/talkpython/modern-apis-with-fastapi.git app_repo 
