...
class Binomial(Distribution):
    ...
    # DONE: write a method calculate_mean() according to the specifications below 
    ...
    # DONE: write a replace_stats_with_data() method according to the specifications below. The read_data_file() from the Generaldistribution class can read in a data
    ...
    # DONE: write a method plot_bar() that outputs a bar chart of the data set according to the following specifications.
    def plot_bar(self):
