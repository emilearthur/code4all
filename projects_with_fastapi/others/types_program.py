...
def counter(items: Iterable[Item]) -> int:
    ...
    # TODO: Add up the prices 
    for i in items:
        total += i.value 

    # TODO: Test for max purchase 
...
def main():
    ...
    breakfast_items = [Item('Pancakes', 11), Item('Bacon', 4), Item('Coffe', 3), Item('Coffe', 3), Item('Scone', 2)]
    ...
    print(f"Today your most expensive meal cost ${running_max:.02f}")
